    ...
    <div class="container">
        ...
        <ul class="nav navbar-nav navbar-right">
            <li class="dropdown">
                <div>
                    @if(Auth::check())
                    <img src="/images/home/user.jpeg" alt="" class="img-rounded" style="border-radius:500px; height: 30px">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="/user/{{Auth::id()}}">个人设置</a></li>
                        <li><a href="/logout">登出</a></li>
                    </ul>
                    @else
                        <a href="/login" class="blog-nav-item dropdown-toggle">请登录</a>
                    @endif
                </div>
            </li>
        </ul>
